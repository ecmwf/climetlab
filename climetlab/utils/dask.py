...
Access the dask dashboard: TODO
Access the dask logs: TODO
...
Custom dask deployement specifications:
...
Create a yaml file in /opt/climetlab/dask/hpc-name-config-1.yaml. User will be able to use it with:
from climetlab.utils.dask import start
start('hpc-name-config-1')
