...
def mcoast(
    *,
    ...
    map_grid_latitude_increment: float = 10,
    map_grid_longitude_reference: float = 0,
    map_grid_longitude_increment: float = 20,
...
def msymb(
    *,
    ...
    symbol_advanced_table_min_value: float = -1000000000000000000000,
    symbol_advanced_table_max_value: float = 1000000000000000000000,
    symbol_advanced_table_level_count: int = 10,
    symbol_advanced_table_level_tolerance: int = 2,
    symbol_advanced_table_interval: float = 8,
    ...
    symbol_advanced_table_height_max_value: float = 0,
    symbol_advanced_table_height_min_value: float = 0,
    ...
    symbol_advanced_table_text_font_size: float = 0,
    ...
    symbol_advanced_table_outlayer_min_value: float = -1000000000000000000000,
    symbol_advanced_table_outlayer_max_value: float = 1000000000000000000000,
    ...
    symbol_scaling_level_0_height: float = 0,
    symbol_scaling_factor: float = 4,
